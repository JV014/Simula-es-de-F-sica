const simulacoes = [
  ...
  },
  {
    ...
    categoria: "MHS",
    descricao: "O pêndulo simples consiste em uma massa (pontual) suspensa por um fio ideal (inextensível e sem massa) que oscila sob a ação da gravidade. Deslocado de sua posição de equilíbrio, a força gravitacional age como força restauradora, tendendo a trazê-lo de volta.
...
Para pequenas oscilações (pequenos ângulos), o movimento do pêndulo simples é aproximadamente harmônico simples, com um período que depende apenas do comprimento do fio e da aceleração da gravidade, sendo independente da massa e da amplitude (para pequenas amplitudes).",
  ...
  },
  {
    titulo: "Corrida",
    categoria: "Cinemática",
    descricao: "Aplicação simples do Movimento Uniforme e Uniformemente Variado com corrida de bolinhas. Quem irá vencer?

Dica: Observe o gráfico!",
